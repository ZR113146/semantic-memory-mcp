# Semantic Memory MCP -- v0.3.0 Language Benchmark
...
| 21 | Go | semantic-memory-mcp (self) | 2,259 | 6,561 | 10.5/12 | 87% | 2 |
...
### Go (semantic-memory-mcp)

**Project**: `semantic-memory-mcp` | **Repo**: self
